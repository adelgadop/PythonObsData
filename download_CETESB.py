...
for i in cetesb_stations.code:
    ...
    qr.all_photo(cetesb_login, cetesb_password, start_date, end_date, i, csv_photo=True)
    print('Downloading meteo ' + cetesb_stations.name[cetesb_stations.code == i].values + ' Station')
    qr.all_met(cetesb_login, cetesb_password, start_date, end_date, i, csv_met=True)
